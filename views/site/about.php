...
<section class="video section section-text-light section-video section-center mt-none" data-video-path="<?=$this->theme->getUrl('video/dark')?>" data-plugin-video-background data-plugin-options='{"posterType": "jpg", "position": "50% 50%", "overlay": true}'>
        <div class="container">
                <div class="row">
                        <div class="col-md-6">
        ...
        <div class="row mt-xlg mb-xlg">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                        <span class="thumb-info thumb-info-hide-wrapper-bg">
                                <span class="thumb-info-wrapper">
                                        <a href="about-me.html">
                                                <img src="<?=$this->theme->getUrl('img/team/team-2.jpg')?>" class="img-responsive" alt="">
                                                <span class="thumb-info-title">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                        <span class="thumb-info thumb-info-hide-wrapper-bg">
                                <span class="thumb-info-wrapper">
                                        <a href="about-me.html">
                                                <img src="<?=$this->theme->getUrl('img/team/team-3.jpg')?>" class="img-responsive" alt="">
                                                <span class="thumb-info-title">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                        <span class="thumb-info thumb-info-hide-wrapper-bg">
                                <span class="thumb-info-wrapper">
                                        <a href="about-me.html">
                                                <img src="<?=$this->theme->getUrl('img/team/team-4.jpg')?>" class="img-responsive" alt="">
                                                <span class="thumb-info-title">
